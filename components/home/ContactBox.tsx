...
const ContactBox: FC<ContactBoxProps> = ({ propertyType }) => {
  ...
  return (
    <section id="contact-us" className="min-h-[100vh] bg-water py-20 box grid grid-cols-2 gap-16 md-screen:grid-cols-1 md-screen:gap-10 sm-screen:py-8 sm-screen:gap-6">
      <section className="flex gap-3 md-screen:flex-col">
        <form onSubmit={(e) => {
          ...
          <header className="grid text-gray-600">
            ...
            <span>
              {"To register your interest in Bijou Homes' finest residences, please fill in the form below. Or contact our sales agents at:"}
            </span>
          </header>
      ...
      <section className=" flex flex-col bg-[#1a1a19] gap-5 p-7 sm-screen:p-5">
        ...
        <section className="flex-1">
          <iframe className="h-full" title="mapBox" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3969.2531362453183!2d-0.10123142564421984!3d5.819880830941097!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf9bf5e49b2f29%3A0xa4ee42257f714fe!2sBijou%20Homes%20Ghana!5e0!3m2!1sen!2sgh!4v1763906508482!5m2!1sen!2sgh"
            width="100%"
